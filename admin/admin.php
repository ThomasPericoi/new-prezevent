...
{
    $blocks = ["ads", "card-location", "content", "content-media", "faq", "features-grid", "highlighting", "logos", "media", "perks", "posts-grid", "shortcode", "slider", "summary", "tabs", "testimonials", "title"];
